...
namespace Studio5JarvisMasterApi.Migrations
{
    ...
    [Migration("20260925063916_AddEaAiUsageUsedTracking")]
    partial class AddEaAiUsageUsedTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jarvis5.Entities.EaFms.EaAiUsageLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("Module", "BusinessRecordId");

                    b.ToTable("ea_ai_usage_logs", "public");
                });
            ...
            modelBuilder.Entity("Jarvis5.Entities.EaFms.FollowupPhaseTat", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("FollowupId", "TaskType", "ReviewCycleNumber")
                        .IsUnique();

                    b.ToTable("ea_followup_phase_tat", "public", t =>
                        {
                            t.HasCheckConstraint("CK_followup_phase_actual", "\"TaskType\" = 'Actual' AND \"ReviewCycleNumber\" = 0");
                        });
                });

            modelBuilder.Entity("Jarvis5.Entities.EaFms.FollowupReminderLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ea_followup_reminder_log", "public");
                });
            ...
            modelBuilder.Entity("Jarvis5.Entities.EaFms.Meeting", b =>
                {
                    ...
                    b.Property<DateTime?>("DelegationDecidedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("DelegationDecidedBy")
                        .HasColumnType("text");

                    b.Property<string>("DelegationDecision")
                        .HasColumnType("text");
